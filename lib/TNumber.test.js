...
const testCases = [
  [
    ...
    // String
    ['[String]: should throw TypeError', ['1', { strict: true }], 'toThrow', TypeError],
    [
    ...
    // Null
    ['[Null]: should throw TypeError', [null, { strict: true }], 'toThrow', TypeError],
    [
    ...
    // Object
    ['[Object]: should throw TypeError', [{}, { strict: true }], 'toThrow', TypeError],
    [
      '[Symbol]: should throw TypeError with correct message',
      [{}, { strict: true }],
      'toThrow',
      new TypeError(getErrorMessage(Object(), '"[object Object]" is not a number')),
    ],
    // Array
    ['[Array]: should throw TypeError', [[], { strict: true }], 'toThrow', TypeError],
    [
      '[Array]: should throw TypeError with correct message',
      [[], { strict: true }],
      'toThrow',
      new TypeError(getErrorMessage(Object(), '"[]" is not a number')),
    ],
  ],
  ...
  [
    ...
    // String
    ['[String]: should return number if string can coerce in number', ['1'], 'toBe', 1],
    [
    ...
    [
      ...
      'toThrow',
      new TypeError(
        getErrorMessage(Symbol('foo'), 'Cannot convert a Symbol value to a number'),
      ),
    ],
    // Object
  ...
  testCases.forEach(([name, ...itTestCases]) => {
    describe(name, () => {
      itTestCases.forEach(([itName, args, method, expectedValue]) => {
        it(itName, () => {
          expect(method === 'toThrow' ? () => TNumber(...args) : TNumber(...args))[
            method
          ](expectedValue);
        });
      });
