...
export class TInterface {
  ...
  static matchOf(object, tInterface) {
    ...
    for (const objKey in object) {
      ...
      if (isDefined) this.#validate(value, TypeConstructor, tInterface);
      objKeys.add(objKey);
    }
  ...
  static matchOfProp(key, value, tInterface) {
    ...
    this.#validate(value, TypeConstructor, tInterface);
  }

  static #validate(value, TypeConstructor, tInterface) {
